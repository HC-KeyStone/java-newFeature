...
public class NewMethodOfMap {
    public static void main(String[] args) {
        ...
        System.out.println("10 new -->" + map.get(10));
        System.out.println("11-->"+map.getOrDefault(11,"val_66"));//11-->val_66

        /**
         * 3:V putIfAbsent(K key, V value):根据key匹配Node,如果匹配不到则增加key-value,返回null;
         * 如果匹配到Node,且oldValue不等于null则不进行value覆盖，返回oldValue
         */
        ...
        /**
         * 5:boolean replace(K key, V oldValue, V newValue):根据key匹配node,
         *   如果value也相同则使用newValue覆盖返回true，否则返回false
         */
        map.put(11,null);
        map.replace(3,"3","33");
